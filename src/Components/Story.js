  ...
  return (
    <div class="paper">
      ...
      <div class="sticky">
        ...
        <p class="writing">
          You are the protagonist attending your first year of high school with
          your neighbor and childhood friend, Nakano Chiho. Growing up the two
          of you always spent time together. However, in high school things
          began to change. As you spend your high school days enjoying your free
          time, Chiho spends her precious high school days making new friends
          and even joining a club.
        </p>
        <p class="writing">
        ...
        <p class="writing">
          As the two of you expand your social circles, something becomes amiss.
          Chiho is spending more and more time with Yoshioka-Senpai and even
          talking about him more lately. Is there something going on between
          them? Why do you care? However, perhaps there is a reason that you
          care?
        </p>
      </div>
      <div class="footer">
